...
sudo swift-ring-builder account.builder add --region 1 --zone 1 --ip 192.168.100.12 --port 6202 --device sdb --weight 100
sudo swift-ring-builder account.builder add --region 1 --zone 1 --ip 192.168.100.12 --port 6202 --device sdc --weight 100
sudo swift-ring-builder account.builder add --region 1 --zone 2 --ip 192.168.100.13 --port 6202 --device sdb --weight 100
sudo swift-ring-builder account.builder add --region 1 --zone 2 --ip 192.168.100.13 --port 6202 --device sdc --weight 100
...
sudo swift-ring-builder container.builder add --region 1 --zone 1 --ip 192.168.100.12 --port 6201 --device sdb --weight 100
sudo swift-ring-builder container.builder add --region 1 --zone 1 --ip 192.168.100.12 --port 6201 --device sdc --weight 100
sudo swift-ring-builder container.builder add --region 1 --zone 2 --ip 192.168.100.13 --port 6201 --device sdb --weight 100
sudo swift-ring-builder container.builder add --region 1 --zone 2 --ip 192.168.100.13 --port 6201 --device sdc --weight 100
...
sudo swift-ring-builder object.builder add --region 1 --zone 1 --ip 192.168.100.12 --port 6200 --device sdb --weight 100
sudo swift-ring-builder object.builder add --region 1 --zone 1 --ip 192.168.100.12 --port 6200 --device sdc --weight 100
sudo swift-ring-builder object.builder add --region 1 --zone 2 --ip 192.168.100.13 --port 6200 --device sdb --weight 100
sudo swift-ring-builder object.builder add --region 1 --zone 2 --ip 192.168.100.13 --port 6200 --device sdc --weight 100
#------------------------------------------------------------------------------
# Verify the ring contents:
#------------------------------------------------------------------------------
...
sudo scp account.ring.gz compute01:/etc/swift/
sudo scp container.ring.gz compute01:/etc/swift/
sudo scp object.ring.gz compute01:/etc/swift/
sudo scp swift.conf compute01:/etc/swift/
...
node_ssh compute01 sudo chown -R root:swift /etc/swift
...
for ringtype in account container object; do 
   node_ssh compute01 sudo systemctl start swift-$ringtype
   node_ssh compute01  sudo systemctl enable swift-$ringtype
    for service in replicator updater auditor; do
        if [ $ringtype != 'account' ] || [ $service != 'updater' ]; then
          node_ssh compute01 sudo systemctl start swift-$ringtype-$service
          node_ssh compute01 sudo systemctl enable swift-$ringtype-$service
        fi
    done
done
