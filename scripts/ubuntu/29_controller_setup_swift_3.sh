...
sudo swift-ring-builder account.builder add --region 1 --zone 1 --ip 192.168.100.13 --port 6202 --device sdb --weight 100
sudo swift-ring-builder account.builder add --region 1 --zone 1 --ip 192.168.100.13 --port 6202 --device sdc --weight 100
...
sudo swift-ring-builder container.builder add --region 1 --zone 1 --ip 192.168.100.13 --port 6201 --device sdb --weight 100
sudo swift-ring-builder container.builder add --region 1 --zone 1 --ip 192.168.100.13 --port 6201 --device sdc --weight 100
...
sudo swift-ring-builder object.builder add --region 1 --zone 1 --ip 192.168.100.13 --port 6200 --device sdb --weight 100
sudo swift-ring-builder object.builder add --region 1 --zone 1 --ip 192.168.100.13 --port 6200 --device sdc --weight 100
#------------------------------------------------------------------------------
# Verify the ring contents:
#------------------------------------------------------------------------------
